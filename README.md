...
| dict.h | 字典数据结构的相关声明，用于 redis 中 hashtable（哈希表）的底层实现 | 完成 |
</p>
...
A: 如果你有对redis源码出bug的问题，建议到redis仓库去提issue。如果你有其他的问题（如面试问题，使用问题），命令的相关用法可以到[redis官网](https://redis.io/)查找，网上实在找不到方法也可以在这里讨论，我们特地开设了一个讨论区（上方的 discuss ）来让大家讨论redis相关问题！在讨论区讨论的时候请记得用词要文明礼貌，别人才会愿意和你交流哦！
